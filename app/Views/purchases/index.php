<form class="mb-3" method="get">
  ...
  <div class="filters">
    ...
    <a class="btn btn-primary filters-end" href="<?= url('purchases/create') ?>"><i class="bi bi-plus-lg"></i> New purchase</a>
  </div>
</form>
<div class="card"><div class="table-responsive">
  <table class="table table-hover align-middle">
    ...
    <?php foreach ($pg['rows'] as $p): ?>
      <tr><td class="text-nowrap"><code><?= e($p['purchase_no']) ?></code></td><td class="text-nowrap"><?= e(date('d/m/Y', strtotime($p['purchase_date']))) ?></td><td dir="auto"><?= e($p['supplier_name'] ?? '—') ?></td>
    ...
    <?php endforeach; ?>
    <?php if ($pg['rows'] === []): ?><tr><td colspan="8" class="empty">No purchases match. Post one when a delivery arrives: stock and cost prices update from it.</td></tr><?php endif; ?>
    </tbody>
  </table>
</div></div>
