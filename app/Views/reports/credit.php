...
<div class="card"><div class="table-responsive"><table class="table table-sm">
  ...
  <tbody><?php foreach ($rows as $c): $tot += (float) $c['balance_usd']; ?>
    <tr><td dir="auto"><?= e($c['name']) ?></td><td class="text-nowrap"><?= e($c['phone'] ?? '') ?></td><td class="text-end text-danger"><?= usd($c['balance_usd']) ?></td><td class="text-end"><?= $c['credit_limit_usd'] === null ? '—' : usd($c['credit_limit_usd']) ?></td></tr>
  <?php endforeach; ?>
